...
.then((client) =>{
    ...
    storeArmoursRouter.post("/reset",(req,res)=>{
        storeArmoursCollection
            .deleteMany({})
            .then(_ => storeArmoursCollection.insertMany([
                {
                    armour:{
                        name:"Headhunter",
                        cost:1000,
    ...
    weaponInventoryRouter.post("/reset",(req,res)=>{
        ...
        .deleteMany({})
        .then(_=>weaponInventoryCollection
            .insertOne(req.body)
            .then((result) => {
                res.json(result.ops[0])
              })
    ...
    armourInventoryRouter.post("/reset",(req,res)=>{
        ...
        .deleteMany({})
        .then(_=>armourInventoryCollection
            .insertOne(req.body)
            .then((result) => {
                res.json(result.ops[0])
              })
